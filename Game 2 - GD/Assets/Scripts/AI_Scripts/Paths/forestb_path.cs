...
public class forestb_path : enemy_hit {
	...
	void Start () {
		points = p.generateScore("forestb");
        health = h.generateHealth("forestb");
	...
	void Update () {
		...
		if (transform.position.y > 5) {
            ...
            } else if (hide == null && GameObject.Find("water02_enemy(Clone)") != null) {
                hide = GameObject.Find("water02_enemy(Clone)");
            } else if (hide == null && GameObject.Find("waterb02_enemy(Clone)") != null) {
                hide = GameObject.Find("waterb02_enemy(Clone)");
            } else if (hide == null && GameObject.Find("city02_enemy(Clone)") != null) {
                hide = GameObject.Find("city02_enemy(Clone)");
            } else if (hide == null && GameObject.Find("cityb02_enemy(Clone)") != null) {
                hide = GameObject.Find("cityb02_enemy(Clone)");
            }
