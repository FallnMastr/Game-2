...
public class space_level : MonoBehaviour {
    ...
    /*bool comp01 = true, comp02 = true, comp03 = true,
         ...
         comp16 = true, comp17 = true, comp18 = true,
         comp19 = true, comp20 = true,
         compB1 = true, compB2 = true, compB3 = true,
         compB4 = false;*/
	...
	void Start () {
        p = KeyCode.P;
		space = (AudioSource)gameObject.AddComponent ("AudioSource");
		AudioClip myAudioClip1;
		myAudioClip1 = (AudioClip)Resources.Load ("tunes/05 Revenge of the Wombat");
		space.clip = myAudioClip1;
		space.volume = 0.05f;
		space.Play ();
		space.loop = true;
        ...
        final = (AudioSource)gameObject.AddComponent("AudioSource");
        AudioClip myAudioClipf;
        myAudioClipf = (AudioClip)Resources.Load("tunes/Muzzy - Endgame (final)");
        final.clip = myAudioClipf;
        final.volume = 0.04f;
	}
	...
	void Update () {
		...
		if (wave01) {
            ...
            goB.transform.Translate(0, 0, 0.01f);
            waveB1 = false;
            time = 0;
		} else if (wave06) {
            Debug.Log("wave 6");
            ...
            go7.transform.Translate(Convert.ToSingle(3.33), 2, 0);
            ...
            go02.transform.Translate(0, 3, 0);
            ...
            go0.transform.Translate(Convert.ToSingle(-4.44), 2, 0);
            GameObject go1 = (GameObject)Instantiate(Resources.Load("forest02_enemy"));
            go1.transform.Translate(Convert.ToSingle(-3.33), 1, 0);
            ...
            go3.transform.Translate(Convert.ToSingle(-1.11), 2, 0);
            ...
            go0.transform.Translate(Convert.ToSingle(-4.44), 1, 0);
            ...
            go3.transform.Translate(Convert.ToSingle(-1.11), 3, 0);
            ...
            go5.transform.Translate(Convert.ToSingle(1.11), 1, 0);
            ...
            go8.transform.Translate(Convert.ToSingle(4.44), 3, 0);

            GameObject go01 = (GameObject)Instantiate(Resources.Load("forest_path"));
            go01.transform.Translate(0, 3, 0);
            GameObject go02 = (GameObject)Instantiate(Resources.Load("water_path"));
            go02.transform.Translate(0, 0, 0);
            ...
            GameObject go4 = (GameObject)Instantiate(Resources.Load("forest02_enemy"));
            go4.transform.Translate(Convert.ToSingle(0), 1, 0);
            ...
            go6.transform.Translate(Convert.ToSingle(2.22), 2, 0);
            GameObject go7 = (GameObject)Instantiate(Resources.Load("city02_enemy"));
            go7.transform.Translate(Convert.ToSingle(3.33), 1, 0);
            GameObject go8 = (GameObject)Instantiate(Resources.Load("water02_enemy"));
            go8.transform.Translate(Convert.ToSingle(4.44), 0, 0);
            ...
            go01.transform.Translate(0, 3, 0);
            GameObject go02 = (GameObject)Instantiate(Resources.Load("city_path"));
            go02.transform.Translate(0, 4, 0);
            ...
            go4.transform.Translate(Convert.ToSingle(0), 1, 0);
            GameObject go5 = (GameObject)Instantiate(Resources.Load("cityb02_enemy"));
            go5.transform.Translate(Convert.ToSingle(1.11), 2, 0);
            GameObject go6 = (GameObject)Instantiate(Resources.Load("forestb02_enemy"));
            go6.transform.Translate(Convert.ToSingle(2.22), 1, 0);
